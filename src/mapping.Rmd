...
Different tables used in this exercise. `emof` table is not shown. Dataset with Humboldt Extension is available at https://ipt.gbif.org/resource?r=brokewest-fish
...
Some of my thoughts and questions that came to my mind

### 1. Should `eco:isTaxonomicScopeFullyReported` be true/false/null if an dwc:Event is **not** associated with any dwc:Occurrence?

In this dataset, every observations were recorded. `eco:isTaxonomicScopeFullyReported` is defined as
