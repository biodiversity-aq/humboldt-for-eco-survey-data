...
```{r, taxonomic-scope-complete, echo=FALSE, message=FALSE}
library(here)
...
Credit to Anton Van de Putte for kindly allowing us to use his dataset to test the extension and the time spend in helping us to understand his data.
